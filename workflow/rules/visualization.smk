...
rule bw:
    ...
    shell:
        """
        # 筛选total count
        bash ./workflow/scripts/filter_bed.sh {params.genome_fasta_fai} {input.sorted_bed} {output.filtered_bed} {params.extract_threshold}
     
        # 转为bw
        /home_data/home/slst/leixy2023/software/bedGraphToBigWig {output.filtered_bed} {params.genome_fasta_fai} {output.filtered_bw}
        """
